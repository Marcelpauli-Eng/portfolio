...
// react-lottie pulls in lottie-web, which touches `document` at module load and
// breaks SSR. Load it client-side only.
    ...
    >
      <div className={cn("h-full", id === 6 && "flex justify-center")}>
        ...
        >
          ...
          <div className="z-10 font-sans text-sm font-light text-[#c1c2d3] md:text-xs lg:text-base whitespace-pre-line md:ml-10">
            {description3}
          </div>
