...
const CardSection: React.FC = () => {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Tighter fan + smaller cards (see CSS) on mobile so the spread stays on-screen.
      const positions = isMobile ? [30, 43, 57, 70] : [14, 38, 62, 86];
      const rotations = isMobile ? [-8, -4, 4, 8] : [-15, -7.5, 7.5, 15];
