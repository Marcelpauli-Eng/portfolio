...
export default function App() {
  return (
    <div style={{ width: '100vw', height: '100vh', touchAction: 'pan-y' }} className="hero-band">
...
function Band({ maxSpeed = 50, minSpeed = 10 }) {
  ...
  // On mobile the visible X range is only ~±1, so center the anchor or the
  // card hangs off-screen to the right.
  const cardPosition = isMobile ? [0, 4, 0] : [3, 4, 0];
