        ...
        <div className="relative w-full bg-[var(--color-bg)]">
          ...
          <div className="relative z-10 flex flex-col w-full -mt-[100dvh] lg:-mt-[100vh]">
            ...
            <section className="hero-section relative w-full h-[100dvh] lg:h-[150vh] flex flex-col justify-start lg:justify-between overflow-hidden pointer-events-none transform-gpu will-change-transform">
              {/* Hero Desktop Text Container - Temporarily Removed per User Request */}
            </section>

            {/* About Section - Bento Grid */}
            <section className="min-h-screen w-full flex flex-col items-center justify-center pointer-events-auto bg-transparent pt-32 lg:pt-48 pb-20 md:pb-32 relative z-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl w-full mx-auto px-6">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-2 flex flex-col justify-center bg-white border-2 border-red-500 rounded-[2rem] p-6 lg:p-10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                  <h2 className="text-outline-red text-4xl lg:text-6xl tracking-tight leading-none mb-4">
                    {t("about.card1.title")}
                  </h2>
                  <p className="text-zinc-700 text-lg lg:text-xl font-light leading-relaxed">
                    {t("about.card1.desc")}
                  </p>
                </div>

                {/* Card 2: Tech Stack */}
                <div className="col-span-1 md:col-span-1 lg:col-span-1 flex flex-col items-center justify-center bg-white border-2 border-red-500 rounded-[2rem] p-6 lg:p-10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 overflow-hidden relative group">
                  ...
                  <div className="flex flex-wrap justify-center gap-2 mt-6 z-10 w-full">
                    {["React", "Next.js", "Spline 3D", "TailwindCSS", "SQL", "Python", "C"].map((tech) => (
                      <span key={tech} className="bg-white border border-red-400 text-red-500 rounded-full px-4 py-1 text-sm font-medium">
                        {tech}
                      </span>
                    ))}
                  </div>
                ...
                <div className="col-span-1 md:col-span-1 lg:col-span-1 flex flex-col justify-center bg-white border-2 border-red-500 rounded-[2rem] p-6 lg:p-10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                  <h3 className="tracking-widest uppercase text-xs font-bold text-red-500 mb-4">
                    {t("about.card3.title")}
                  </h3>
                  <p className="text-zinc-700 text-base lg:text-lg font-light leading-relaxed">
                    {t("about.card3.desc")}
                  </p>
                </div>

                {/* Card 4: Filosofía / Proyectos */}
                <div className="col-span-1 md:col-span-2 lg:col-span-2 flex flex-col lg:flex-row items-start lg:items-center justify-between bg-white border-2 border-red-500 rounded-[2rem] p-6 lg:p-10 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1">
                  <div className="max-w-xl mb-6 lg:mb-0">
                    <h3 className="tracking-widest uppercase text-xs font-bold text-red-500 mb-4">
                      {t("about.card4.title")}
                    </h3>
                    <p className="text-zinc-700 text-xl font-light tracking-tight leading-snug">
                      {t("about.card4.desc")}
                    </p>
                  </div>
