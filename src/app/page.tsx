      ...
      <main ref={mainRef} className="relative w-full z-10 pointer-events-none">
        ...
        <div className="relative w-full bg-black">
          ...
          <div className="relative z-10 flex flex-col w-full -mt-[100vh]">
            ...
            <section className="min-h-[150vh] w-full flex items-center justify-center md:justify-end py-16 md:py-32 px-6 md:px-20 pointer-events-auto bg-gradient-to-b from-transparent via-black/80 to-black">
